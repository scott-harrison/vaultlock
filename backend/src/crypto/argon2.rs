...
pub fn hash_login_password(password: &str) -> Result<String, argon2::password_hash::Error> {
    ...
    let argon2 = Argon2::new(
        ...
        Params::new(ARGON2_MEMORY_KB, ARGON2_ITERATIONS, ARGON2_PARALLELISM, None)?,
    );
...
pub fn verify_login_password(password: &str, hash: &str) -> Result<bool, argon2::password_hash::Error> {
